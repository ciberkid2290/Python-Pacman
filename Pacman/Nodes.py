...
class Node(object):
    def __init__(self, x, y):
        ...
        self.neighbors = {UP:None, DOWN:None, LEFT:None, RIGHT:None, PORTAL:None, TUNNEL:None}
    ...
    # Render method for testing. Won't actually render them in final game
...
# Class for dealing with multiple nodes
