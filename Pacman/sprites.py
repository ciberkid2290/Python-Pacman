...
class Spritesheet(object):
    def __init__(self):
        self.sheet = pygame.image.load(f"{path}/assets/Pac-Man_Comparable_Sprite_Sheet.png").convert()
...
class PacmanSprites(Spritesheet):
    ...
    def update(self, dt):
        if self.entity.alive == True:
            ...
            elif self.entity.direction is STOP:
...
class FruitSprites(Spritesheet):
    def __init__(self, entity, level):
        Spritesheet.__init__(self)
        self.entity = entity
        self.fruits = {0:(16, 8), 1:(28, 8), 2:(20,8), 3:(16, 10), 4:(18, 10), 5:(20, 10)}
